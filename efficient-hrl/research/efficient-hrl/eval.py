...
def get_eval_step(uvf_agent,
  ...
  """
    ...
    eval_step = [next_state, action_ph, transition_type, post_reward, post_meta_reward, discount,
                 uvf_agent.context_vars, state_repr]
...
def evaluate(checkpoint_dir,
  ...
  """
    ...
    """ Steps:
    1) Setup the environment and the observation / action specs
    2) Create the agent, the meta agent and state preprocesor
    3) Evaluate the system once with META agent and N times without a META agent
