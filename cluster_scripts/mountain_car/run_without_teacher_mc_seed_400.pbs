...
python3 hierarchical_algos/run_hac_general.py --render-rounds 0 --no-render --eval-frequency 30 --use-tensorboard --run-on-cluster  --seed 400 --env-name "MountainCar" --num-training-episodes 2000
